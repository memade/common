...
#else
#pragma comment(lib,"../../../bin/lib/Win32/Release/libdui.lib")
#endif
#elif defined _M_X64
#if defined(_DEBUG)
...
namespace sk {
	namespace ui {
		...
		public:
			...
			~UIWindowDispatch() {
				m_UIWindowPtrQ.iterate(
					[](const auto& _pClassName, auto& _pUIWindow) {
		...
		private:
			HINSTANCE* m_hInstance = nullptr;
			HWND m_hParent = nullptr;
			sk::container::map<sk::string, UIWindow*> m_UIWindowPtrQ;
		};
